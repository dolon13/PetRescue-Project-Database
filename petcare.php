...
<body class="presentation-page bg-gray-200">
    ...
    <nav
        ...
        <div class="container">
            ...
            <a href="#" class="btn btn-sm  bg-gradient-secondary  btn-round mb-0 ms-auto d-lg-none d-block">Be a
                savior</a>
            ...
            <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
                <ul class="navbar-nav navbar-nav-hover mx-auto">
                    <li class="nav-item mx-2">
                        <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center"
                            role="button" href="adoption/adoptionhome.php">
                    ...
                    <li class="nav-item mx-2">
                        <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center"
                            role="button" href="needhelp.php">
                            Need Help?
                        </a>
                    </li>
                    <li class="nav-item mx-2">
                        <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center"
                            role="button" href="petcare.php">
                            pet care
                        </a>
                    </li>
                </ul>
                ...
                <ul class="navbar-nav d-lg-block d-none">
                    <li class="nav-item">
                        ...
                        <a href="user/" class="btn btn-sm  bg-gradient-secondary  mb-0 me-1" role="button">Be a
                            savior</a>
    ...
    <header class="header-2">
        <div class="page-header min-vh-75" style="background-image: url('assets/images/background_index.webp')"
            loading="lazy">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 text-center mx-auto">
                        ...
                        <p class="lead text-white mt-3 px-5">proper care for your loved one.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="rotating-card-container">
                        <div
                            ...
                            <div class="front front-background"
                                style="background-image: url(assets/images/cat.png); background-size: cover;">
                                <div class="card-body py-7 text-center">
                                    <i class="material-icons text-white text-4xl my-3">touch_app</i>
                                    <h3 class="text-white">Know about <br /> dogs care</h3>
                                    <p class="text-white opacity-8">You need to provide for its needs, both physical and
                                        emotional. This means providing nutritious food, clean drinking water, shelter,
                                        and the opportunity to live in a safe home. </p>
                                </div>
                            </div>
                            <div class="back back-background"
                                style="background-image: url(assets/images/cat.png); background-size: cover;">
                                <div class="card-body pt-7 text-center">
                                    <h3 class="text-white">know about cats</h3>
                                    <p class="text-white opacity-8"> Routine health care refers to the non-emergency,
                                        general care that is needed to keep your cat healthy throughout its life.
                                        This includes routine veterinary care for vaccinations,
                                        parasite control, and dental care; proper nutrition; grooming;
                                        and protection from household hazards</p>
                ...
                <div class="col-lg-6 ms-auto">
                    <div class="row justify-content-start">
                        <div class="col-md-6">
                            <div class="info">
                                ...
                                <p class="pe-5">We ensure correct documentation of any animal that we rescued and that
                                    we successfully manage to rehabitate.</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info">
                    ...
                    <div class="row justify-content-start mt-5">
                        <div class="col-md-6 mt-3">
                            ...
                            <p class="pe-5">Our main goal to save as many life of those poor animals as possible. They
                                are same as us one creation of GOD, why they can not be loved ?</p>
                        </div>
                        <div class="col-md-6 mt-3">
                            <div class="info">
                                ...
                                <p class="pe-3">
                                    There are lot of good hearted people who volunteered for us to rescue animals and
                                    ensure safe home for them. Please do a big applaud for them.
                                </p>
                            </div>
                        </div>
                    </div>
